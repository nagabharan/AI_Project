...
var CrosswordUtils = {
    ...
    toHtml : function(grid, show_answers){
        if(grid == null) return;
        var html = [];
        html.push("<table align='center' class='crossword'>");
        var label = 1;    
        for(var r = 0; r < grid.length; r++){
            html.push("<tr>");
            for(var c = 0; c < grid[r].length; c++){
                ...
                if(is_start_of_word) {
                    ...
                    html.push("<td class='" + css_class + "' title='" + r + ", " + c + "' style=\"border-style:solid;border-color:#000000;padding-top: 5px;padding-right: 5px;padding-bottom: 5px;padding-left: 5px;background-image:url('" + img_url + "')\">");
                    label++;            
                } else {
                    html.push("<td class='" + css_class + "' title='" + r + ", " + c + "' style=\"border-style:solid;border-color:#000000;padding-top: 5px;padding-right: 5px;padding-bottom: 5px;padding-left: 5px;\">");                   
                }
